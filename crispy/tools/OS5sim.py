...
ratio_out = SNR_spectrum(
    ...
    "/Inputs/LAS_spectra_for_exospec_bright_comparison_at_90_deg_phase.txt",
    albedo=None,
...
np.savetxt(folder + "/average/final_signal_cube_sergi_" +
           str(par.timeframe) + ".txt", final_signal_cube)
np.savetxt(folder + "/average/final_signal_no_rdi_cube_sergi_" +
           str(par.timeframe) + ".txt", final_signal_no_rdi_cube)
np.savetxt(folder + "/average/final_signal_star_cube_sergi_" +
           str(par.timeframe) + ".txt", final_signal_no_rdi_cube)
np.savetxt(folder + "/average/final_signal_planet_cube_sergi_" +
           str(par.timeframe) + ".txt", final_signal_no_rdi_cube)
