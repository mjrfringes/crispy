...
ratio_out = SNR_spectrum(lam_midpts,signal,noise,filename=par.codeRoot+"/Inputs/Jupiter_1x_5AU_90deg.dat",albedo=None,lam_contrast=wavelist,outfolder=par.exportDir+"/",
